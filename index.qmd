...
d <- cantril %>%  select(-Code) %>%  filter(Year %in% c(2011, 2023)) %>%  
  pivot_wider(names_from = Year,values_from = "Cantril ladder score") %>%  
  mutate("2011" = round(`2011`, 2), "2023" = round(`2023`, 2),
         "Absolute change" = round(`2011` -`2023`, 2), 
         "Relative change" = scales::percent(c(`2011` -`2023`)/`2011`, accuracy=1))
